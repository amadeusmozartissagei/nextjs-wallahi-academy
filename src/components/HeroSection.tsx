        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            <div className="space-y-4 lg:space-y-6">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-[#1F2756] leading-tight">
                Bangun <span className="text-[#1F2756]">karirmu</span>,<br />
                bersama <span className="text-[#1F2756]">kami</span><br />
                <span className="bg-[#00ACF8] text-[#FFFFFF] inline-block px-2 sm:px-3 py-1 sm:py-2 rounded mt-2 text-2xl sm:text-3xl md:text-4xl lg:text-5xl">mulai sekarang</span>
              </h1>
              
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-900 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                Kami bantu kamu tingkatkan keterampilan, raih sertifikasi resmi, dan siap hadapi dunia kerja dengan lebih percaya diri!
              </p>

              <div className="flex justify-center lg:justify-start pt-4 lg:pt-6">
                <a 
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-lg lg:max-w-none">
              <Image 
                ...
                priority
                unoptimized
                className="w-full h-auto object-cover object-center lg:object-right rounded-lg lg:rounded-xl shadow-2xl" 
              />
            </div>
          </div>
        </div>
