        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-16 lg:px-20">
          <div className="flex items-center justify-center lg:justify-end">
            ...
            <div className="w-full lg:w-2/3 xl:w-1/2 text-center lg:text-left space-y-4 lg:space-y-6">
              ...
              {/* Benefits Grid */}
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-4 text-white mt-6 lg:mt-8">
                {/* Box 1 - Komisi */}
                <div className="flex flex-col items-center lg:items-start bg-white/10 backdrop-blur-sm rounded-xl p-3 lg:p-4 hover:bg-white/20 transition-all duration-300">
                  <div className="mb-2 lg:mb-3">
                    <div className="w-10 h-10 lg:w-12 lg:h-12 bg-[#00ACF8] rounded-lg flex items-center justify-center">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5 lg:w-6 lg:h-6 text-white">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm3 0h.008v.008H18V10.5Zm-12 0h.008v.008H6V10.5Z" />
                      </svg>
                    </div>
                  </div>
                  <h3 className="text-sm sm:text-base lg:text-lg font-bold mb-1 lg:mb-2 text-center lg:text-left drop-shadow-md">Komisi Puluhan Juta</h3>
                  <p className="text-xs sm:text-sm lg:text-sm font-light text-center lg:text-left drop-shadow-sm leading-snug">
                ...
                <div className="flex flex-col items-center lg:items-start bg-white/10 backdrop-blur-sm rounded-xl p-3 lg:p-4 hover:bg-white/20 transition-all duration-300">
                  ...
                  <h3 className="text-sm sm:text-base lg:text-lg font-bold mb-1 lg:mb-2 text-center lg:text-left drop-shadow-md">Didampingi Tim Kami</h3>
                  <p className="text-xs sm:text-sm lg:text-sm font-light text-center lg:text-left drop-shadow-sm leading-snug">
                ...
                {/* Box 3 - Kemudahan */}
                <div className="flex flex-col items-center lg:items-start bg-white/10 backdrop-blur-sm rounded-xl p-3 lg:p-4 hover:bg-white/20 transition-all duration-300 sm:col-span-2 lg:col-span-1">
                  <div className="mb-2 lg:mb-3">
                    <div className="w-10 h-10 lg:w-12 lg:h-12 bg-[#00ACF8] rounded-lg flex items-center justify-center">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5 lg:w-6 lg:h-6 text-white">
                  ...
                  <h3 className="text-sm sm:text-base lg:text-lg font-bold mb-1 lg:mb-2 text-center lg:text-left drop-shadow-md">Komisi Cepat & Mudah</h3>
                  <p className="text-xs sm:text-sm lg:text-sm font-light text-center lg:text-left drop-shadow-sm leading-snug">
