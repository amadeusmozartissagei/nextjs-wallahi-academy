...
export default function MitraCTA() {
  return (
    <section className="w-full bg-gradient-to-br from-[#05E089] to-[#00ACF8] flex items-center">
      <div className="grid grid-cols-1 md:grid-cols-[1fr_4fr] max-w-7xl mx-auto px-6 sm:px-8 gap-8 items-center py-10 md:py-0">
        ...
        <div className="flex flex-col space-y-2 sm:space-y-3 text-center md:text-left">
          ...
          <div className="mb-20">
            <a href="https://wa.me/+6281127011818" className="bg-white text-[#05E089] font-semibold px-5 sm:px-6 py-2.5 sm:py-3 rounded-2xl shadow hover:bg-gray-100 transition">
              Daftar Sekarang!
            </a>
          </div>
        </div>
